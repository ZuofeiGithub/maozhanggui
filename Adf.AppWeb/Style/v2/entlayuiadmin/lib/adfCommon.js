  ...
  //……
    ...
    var o = {
       ...
       ,setStdTable: function (table,colInfo,dataUrl, pagesie,sWhere, eventFunc) {
        ...
        , dlgSelectProjectCate: function (projectcode,width, height, endFunc) {
            //title,frameUrl, width,height,endFunc
            var title = "选择角色";
            var frameUrl = "/ent/CompanyTaskCate/Select?type=1&projectcode=" + projectcode;
            //打开用户选择框
            o.dlgOpen(title, frameUrl, width, height, endFunc);
        }
        //--------------------------------------
        , dlgSelectCompanyUser: function (width, height, endFunc) {
            //title,frameUrl, width,height,endFunc
            var title = "选择企业用户";
            var frameUrl = "/Ent/CompanyUser/SelectCompanyUser";
            //打开用户选择框
            o.dlgOpen(title, frameUrl, width, height, endFunc);
        }
